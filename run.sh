...
print_url() {
  ...
  echo ""
  echo "── Phase 11g v0.3.1 vignette 재평가 (/vignette-review-v0_3_1.html) ──"
  echo "Local:     http://127.0.0.1:${PORT}/vignette-review-v0_3_1.html"
  if [[ -n "$ip" ]]; then
    echo "Tailscale: http://${ip}:${PORT}/vignette-review-v0_3_1.html"
  fi
  echo ""
